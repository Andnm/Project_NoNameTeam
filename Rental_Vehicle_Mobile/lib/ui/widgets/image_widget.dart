...
class RoundNetworkImage extends StatelessWidget {
  ...
  RoundNetworkImage(
      {required this.width, required this.height, this.url, this.radius, this.boxFit, this.strokeColor, this.strokeWidth, this.showImageError = true});
...
class RoundNetworkImageTopRadius extends StatelessWidget {
  ...
  RoundNetworkImageTopRadius(
      {required this.width, required this.height, this.url, this.radius, this.errorHolder, this.boxFit, this.strokeColor, this.strokeWidth});
