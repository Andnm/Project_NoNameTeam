...
class NotificationController extends BaseListController<NotificationItem> {
  ...
  final ListTest = [
    NotificationItem(
        ...
        content: "Cập nhật ngay số điện thoại, địa chỉ email để hưởng ngay những ưu đãi nhé"),
    ...
    NotificationItem(
        ...
        content: "Bạn đã thanh toán thành công đơn hàng H591061. Nhấn vào xem lại chi tiết."),
    NotificationItem(
        isRead: true.obs, title: "Nâng cấp hệ thống", content: "Các kênh liên hệ hỗ trợ khách hàng của chúng tôi sẽ bị gián đoạn 22h tối hôm nay(9/5) đến…")
  ];
}
